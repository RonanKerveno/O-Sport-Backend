...
router.get('/:id/private', authorized, userCtrl.getOneUserPrivate);
// crée un nouvel utilisateur.
router.post('/', userCtrl.createOneUser);
// met à jour les informations de l’utilisateur ciblé par l’ID.
router.patch('/:id', authorized, userCtrl.updateOneUser);
// supprime un utilisateur ciblé par l’ID.
router.delete('/:id', authorized, userCtrl.deleteOneUser);
