...
router.post('/:id/events/:event_id', userCtrl.addOneUserToOneEvent);
// supprime un utilisateur identifié par son ID de l’événement identifié par son ID.
router.delete('/:id/events/:event_id', userCtrl.deleteOneUserFromOneEvent);
...
router.post('/:id/sports/:sport_id', userCtrl.addOneSportToOneUser);
// supprime le sport identifié par son ID à l’utilisateur identifié par son ID.
router.delete('/:id/sports/:sport_id', userCtrl.deleteOneSportToOneUser);
